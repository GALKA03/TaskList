import { deleteUserById, getUserById, getAllUsersService, updateUserById } from "../services/userService";
...
export const updateUser = async (req:Request<UserParams, any, UpdateUserBody>, res:Response) => {
  try {
    const { id } = req.params;
